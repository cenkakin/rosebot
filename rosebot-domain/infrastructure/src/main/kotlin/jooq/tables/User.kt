...
open class User(
     ...
     */
    val CREATED_AT: TableField<UserRecord, OffsetDateTime?> =
        createField(
            DSL.name("created_at"),
            SQLDataType
    ...
    constructor(path: Table<out Record>, childPath: ForeignKey<out Record, UserRecord>?, parentPath: InverseForeignKey<out Record, UserRecord>?) : this(
    ...
    ): User = where(DSL.condition(condition))
    ...
    @PlainSQL override fun where(
        @Stringly.SQL condition: String,
        vararg binds: Any?,
    ): User = where(DSL.condition(condition, *binds))
    ...
    ): User = where(DSL.condition(condition, *parts))
