...
open class Source(
     ...
     */
    val TYPE: TableField<SourceRecord, SourceType?> =
        createField(DSL.name("type"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(SourceType::class.java), this, "")
     ...
     */
    val ENABLED: TableField<SourceRecord, Boolean?> =
        createField(
            DSL.name("enabled"),
     ...
     */
    val CREATED_AT: TableField<SourceRecord, OffsetDateTime?> =
        createField(
            DSL.name("created_at"),
            SQLDataType
    ...
    constructor(path: Table<out Record>, childPath: ForeignKey<out Record, SourceRecord>?, parentPath: InverseForeignKey<out Record, SourceRecord>?) : this(
    ...
    ): Source = where(DSL.condition(condition))
    ...
    @PlainSQL override fun where(
        @Stringly.SQL condition: String,
        vararg binds: Any?,
    ): Source = where(DSL.condition(condition, *binds))
    ...
    ): Source = where(DSL.condition(condition, *parts))
